...
function convertDate(epoch) {
  ...
  let time = `${dayWeek}, ${dayMonth} ${month}, ${year}`;
  return time;
}
...
function showWeatherDetailsForecast(response) {
  ...
  day1Forecast = response.data.list[0].dt;
  ...
  let maxT6 = Math.round(response.data.list[5].main.temp_max);
