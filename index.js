...
function showWeatherDetailsForecast(response) {
  ...
  let maxT1 = Math.round(response.data.list[7].main.temp_max);
  maxTemp1.innerHTML = `${maxT1}°C`;
  let minTemp1 = document.querySelector("#minTemp1");
  let minT1 = Math.round(response.data.list[7].main.temp_min);
  ...
  let maxT5 = Math.round(response.data.list[23].main.temp_max);
  maxTemp5.innerHTML = `${maxT5}°C`;
  let minTemp5 = document.querySelector("#minTemp5");
  let minT5 = Math.round(response.data.list[23].main.temp_min);
  minTemp5.innerText = `${minT5}°C`;
  let humidity5 = document.querySelector("#humidity5");
  let hum5 = response.data.list[23].main.humidity;
  humidity5.innerText = `Hum: ${hum5}%`;
  let wind5 = document.querySelector("#wind5");
  let windNext5 = Math.round(response.data.list[23].wind.speed);
  wind5.innerText = `Wind: ${windNext5}km/h`;

  let date6 = document.querySelector("#day6");
  day6Forecast = response.data.list[25].dt;
  day6Forecast = convertDate(day6Forecast);
  date6.innerHTML = day6Forecast;

  let weather6 = document.querySelector("#descripWeather6");
  weather6.innerHTML = response.data.list[25].weather[0].description;
  ...
  let maxTemp6 = document.querySelector("#maxTemp6");
  let maxT6 = Math.round(response.data.list[25].main.temp_max);
  maxTemp6.innerHTML = `${maxT6}°C`;
  let minTemp6 = document.querySelector("#minTemp6");
  let minT6 = Math.round(response.data.list[25].main.temp_min);
  minTemp6.innerText = `${minT6}°C`;
  let humidity6 = document.querySelector("#humidity6");
  let hum6 = response.data.list[25].main.humidity;
  humidity6.innerText = `Hum: ${hum6}%`;
  let wind6 = document.querySelector("#wind6");
  let windNext6 = Math.round(response.data.list[25].wind.speed);
